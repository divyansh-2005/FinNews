...
const FAQModal = ({ onClose }) => {
  ...
  const faqData = [
    ...
    { question: "Can Fin-Buddy provide stock recommendations? ", answer: "Yes, Fin-Buddy can analyze stock performance and provide recommendations based on market data. However, these are suggestions, and we always recommend consulting a financial advisor before making investment all decisions." },
    { question: "Can I access Prolega on multiple devices?", answer: "Yes, you can use your Prolega account on multiple devices by logging in with your credentials. Your data and preferences will sync automatically across the platforms." },
    { question: "Can Prolega provide tax-efficient investment strategies?", answer: "Yes, Prolega offers tax-efficient strategies by analyzing your portfolio and suggesting adjustments such as tax-loss harvesting, optimal asset location (placing assets in tax-advantaged accounts), and capital gains deferral. Our AI also monitors changes in tax laws to offer personalized advice on how to maximize after-tax the  returns." },
  ];
